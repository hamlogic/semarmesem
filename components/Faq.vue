...
<section class="py-24 bg-white border-b border-gray-200" id="faq">
    <div class="px-8 mx-auto max-w-7xl lg:px-16">
        <h2 class="mb-4 text-xl font-bold md:text-3xl">Frequently <span class="text-purple-500">Asked Questions</span></h2>
        <div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
            <div>
                ...
                <p>Semarmesem.art is created by 2 man who want to bring the cultural Javanesse mythology to be a NFTs. Scroll to Team Section on this page to know more.</p>
            ...
            <div>
                ...
                <p>We exclusive on Foundation.app, you can collect the art there. Also you can trade on the marketplace that support Ethereum Blockchain because we have our own Smart Contract, you can easily trade the art all over the Ethereum Chain Marketplace.</p>
