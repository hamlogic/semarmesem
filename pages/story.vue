...
<br/><br/>
Then Rama and Laksmana tried to get her back. In their endeavor they got help from the incarnation of Shiva Hanuman. In the end Rawana was killed. Rama and Sinta then returned to Ayodya where Rama was crowned.
          </p>
          <p class="text-small">This story based on <i>Kakawin Ramayana, Wikipedia</i></p>
        </div>
      </div>
